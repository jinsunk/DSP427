/**
  ...
  *
  *          The STM32F4xx is configured to run at 168 MHz, following the three
  *          configuration below:
...
#define PLL_M      16
#else
#define PLL_M      25		// modified by sooan
#endif

// #define	SYSCLK		168000000		// system clock을 168MHz로 돌림
#define	SYSCLK		180000000		// system clock을 168MHz로 돌림

#if	(SYSCLK==180000000)
	#define PLL_N      360

	/* USB OTG FS, SDIO and RNG Clock =  PLL_VCO / PLLQ */
	#define PLL_Q      7	// 48 Mhz가 정확히 떨어지지 않음. 7.5가 되어야 함

#elif (SYSCLK==168000000)
	#define PLL_N      336
...
#else
	error "specify system clcok you want."
#endif
...
/******************************************************************************/
  ...
  { /* If HSE fails to start-up, the application will have wrong clock
    ...
    /* Enable the Over-drive to extend the clock frequency to 168 Mhz */
    PWR->CR |= PWR_CR_ODEN;
	...
	//	HCLK	180MHz
	//	PCLK1	45MHz
	//	TIM2,3,4,5,6,7,12,13,14		90Mhz
	//	PCLK2	90MHz
	//	TIM1,8,9,10,11				180MHz
	// RCC->DCKCFGR |= RCC_DCKCFGR_TIMPRE;
	// see p150, reference manual
}
